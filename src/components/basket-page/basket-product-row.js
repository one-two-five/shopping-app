    ...
    return(
        <div className='basket-product-row'>
            <div className='basket-product-row-left'>
                <img src="https://www.richersounds.com/media/catalog/product/b/8/b848d36da64ed7ae73fb384c05dfc22227926dcf_319228_v5.jpg?width=260&height=220&canvas=260:220&quality=80&bg-color=255,255,255&fit=bounds&dpr=2"></img>
